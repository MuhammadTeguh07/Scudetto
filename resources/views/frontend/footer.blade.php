  ...
  <footer id="footer" class="hoc clear"> 
    <div class="one_quarter first">
      ...
      <ul class="faico clear">
        <li><a class="faicon-facebook" href="#"><i class="fa fa-facebook" style="margin-top:10px"></i></a></li>
        <li><a class="faicon-twitter" href="#"><i class="fa fa-twitter" style="margin-top:10px"></i></a></li>
        <li><a class="faicon-dribble" href="#"><i class="fa fa-dribbble" style="margin-top:10px"></i></a></li>
        <li><a class="faicon-linkedin" href="#"><i class="fa fa-linkedin" style="margin-top:10px"></i></a></li>
      </ul>
    </div>
...
<!-- JAVASCRIPTS -->
<script src="{{ asset('template/skaxis/layout/scripts/jquery.min.js') }}"></script>
<script src="{{ asset('template/skaxis/layout/scripts/jquery.backtotop.js') }}"></script>
<script src="{{ asset('template/skaxis/layout/scripts/jquery.mobilemenu.js') }}"></script>
<script src="{{ asset('template/skaxis/layout/scripts/jquery.flexslider-min.js') }}"></script>

<!-- jQuery --> 
<script src="{{ asset('template/gentela/vendors/jquery/dist/jquery.min.js') }}"></script>
<!-- Bootstrap -->
<script src="{{ asset('template/gentela/vendors/bootstrap/dist/js/bootstrap.min.js') }}"></script>
